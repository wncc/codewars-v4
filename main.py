...
class Game():
    def __init__(self, dim, red_team, blue_team):
        ...
        self.__red_team = Team(self.screen, 'red', self.__red_pirates, self.__Pirates, self, base_red)
        self.__blue_team = Team(self.screen, 'blue', self.__blue_pirates, self.__Pirates, self, base_blue)
    ...
    def create_map(self):
        ...
        while len(self.__rum) < frac:
            ...
            if (x, y) not in self.__rum and (x, y) not in self.__island1.coordi and (x, y) not in self.__island2.coordi and (x, y) not in self.__island3.coordi:
        ...
        while len(self.__gunpowder) < frac:
            x = random.randint(0, self.__dim[0]-1)
            y = random.randint(0, self.__dim[1]-1)
            if (x, y) not in self.__gunpowder and (x, y) not in self.__rum and (x, y) not in self.__island1.coordi and (x, y) not in self.__island2.coordi and (x, y) not in self.__island3.coordi:
        ...
        while len(self.__wood) < frac:
            x = random.randint(0, self.__dim[0]-1)
            y = random.randint(0, self.__dim[1]-1)
            if (x, y) not in self.__gunpowder and (x, y) not in self.__rum and (x, y) not in self.__wood and (x, y) not in self.__island1.coordi and (x, y) not in self.__island2.coordi and (x, y) not in self.__island3.coordi:
    ...
    def run_game(self):
        ...
        while True:
            ...
            if iter <= 1000:
                ...
                self.__red_team.buildWalls(self.__island1, self.__island2, self.__island3, 1)
                ...
                island_img = pygame.image.load("images/flag1.jpg")
                ...
                island_img = pygame.image.load("images/flag2.jpg")
                island_rect = island_img.get_rect()
                island_rect.center = (self.flag2[0]* 20+10, self.flag2[1]* 20+10)
                self.screen.blit(island_img, island_rect)

                island_img = pygame.image.load("images/flag3.jpg")
                island_rect = island_img.get_rect()
                ...
                scriptred.ActTeam(self.__red_team)
                scriptblue.ActTeam(self.__blue_team)

                if (rnd()>0.5):                              
                    for pirate_i in self.__red_pirates:
                        try:
                            n = scriptred.ActPirate(pirate_i)
                        except:
                            n=0
                            print("Redbot error")
                        moves[pirate_i] = n
                    for pirate_i in self.__blue_pirates:
                        try:
                            n = scriptblue.ActPirate(pirate_i)
                        except:
                            n=0
                            print("Blubot error")
                        moves[pirate_i] = n
                ...
                for pirate_i, n in moves.items():
                    if n == 1:                    
                        ...
                        pirate_i.move_right( self.__island1, self.__island2, self.__island3)
                    elif n == 3:
                        pirate_i.move_down(self.__island1, self.__island2, self.__island3)
                    elif n == 4:
                        pirate_i.move_left( self.__island1, self.__island2, self.__island3)  
    ...
    def discovery(self):
        for pirate in self.__red_pirates:
            if pirate.investigate_up() == "island1" or pirate.investigate_down() == "island1" or pirate.investigate_left() == "island1" or pirate.investigate_right() == "island1" or pirate.investigate_nw() == "island1" or pirate.investigate_ne() == "island1" or pirate.investigate_sw() == "island1" or pirate.investigate_se() == "island1":
                pirate._Pirate__myTeam._Team__flag1 = self.flag1
            elif pirate.investigate_up() == "island2" or pirate.investigate_down() == "island2" or pirate.investigate_left() == "island2" or pirate.investigate_right() == "island2" or pirate.investigate_nw() == "island2" or pirate.investigate_ne() == "island2" or pirate.investigate_sw() == "island2" or pirate.investigate_se() == "island2":
                pirate._Pirate__myTeam._Team__flag2 = self.flag2
            elif pirate.investigate_up() == "island3" or pirate.investigate_down() == "island3" or pirate.investigate_left() == "island3" or pirate.investigate_right() == "island3" or pirate.investigate_nw() == "island3" or pirate.investigate_ne() == "island3" or pirate.investigate_sw() == "island3" or pirate.investigate_se() == "island3":
    ...
    def check_collisions(self):
        removals = pygame.sprite.groupcollide(self.__blue_pirates, self.__red_pirates, False, False)
        to_kill = set()
        for b, r_list in removals.items():
            ...
            for r in r_list:
                ...
                if self.__blue_team._Team__gunpowder > 100 and self.__red_team._Team__gunpowder > 100:
                    to_kill.add(r)
                    to_kill.add(b)
    ...
    def update_score(self):
        ...
        blue_head = head_font.render("BLUE", False, (130,130,255))
        self.screen.blit(blue_head, ((self.__dim[0])*20+ 30, self.__dim[1]*2.5))
        blue_total = norm_font.render("Total rum :" + str(round(self.__blue_team._Team__rum,2)), False, (230,230,230))
        self.screen.blit(blue_total, ((self.__dim[0])*20+50, self.__dim[1]*5 ))
        blue_total = norm_font.render("Total gunpowder :" + str(round(self.__blue_team._Team__gunpowder,2)), False, (230,230,230))
        self.screen.blit(blue_total, ((self.__dim[0])*20+50, self.__dim[1]*5 + 20))
        blue_total = norm_font.render("Total wood :" + str(round(self.__blue_team._Team__wood,2)), False, (230,230,230))
        self.screen.blit(blue_total, ((self.__dim[0])*20+50, self.__dim[1]*5 + 40)) 
        blue_flag1coordi = norm_font.render("Flag 1 : " + str(self.__blue_team._Team__flag1), False, (230,230,230))
        self.screen.blit(blue_flag1coordi, ((self.__dim[0])*20+50, self.__dim[1]*5 + 80))
        blue_flag2coordi = norm_font.render("Flag 2 : " + str(self.__blue_team._Team__flag2), False, (230,230,230))
        self.screen.blit(blue_flag2coordi, ((self.__dim[0])*20+50, self.__dim[1]*5 + 100))
        blue_flag3coordi = norm_font.render("Flag 3 : " + str(self.__blue_team._Team__flag3), False, (230,230,230))
        self.screen.blit(blue_flag3coordi, ((self.__dim[0])*20+50, self.__dim[1]*5 + 120))        
        blue_Pirates = norm_font.render("No. of Pirates: " +str(len(self.__blue_pirates)), False, (230,230,230))        
        self.screen.blit(blue_Pirates, ((self.__dim[0])*20+50, self.__dim[1]*5 + 60))
        red_flag1coordi = norm_font.render("Flag 1 : " + str(self.__red_team._Team__flag1), False, (230,230,230))
        self.screen.blit(red_flag1coordi, ((self.__dim[0])*20+50, self.__dim[1]*12 + 80))
        red_flag2coordi = norm_font.render("Flag 2 : " + str(self.__red_team._Team__flag2), False, (230,230,230))
        self.screen.blit(red_flag2coordi, ((self.__dim[0])*20+50, self.__dim[1]*12 + 100))
        red_flag3coordi = norm_font.render("Flag 3 : " + str(self.__red_team._Team__flag3), False, (230,230,230))
        self.screen.blit(red_flag3coordi, ((self.__dim[0])*20+50, self.__dim[1]*12 + 120))

        red_head = head_font.render("RED", False, (255,130,130))
        self.screen.blit(red_head, ((self.__dim[0])*20+30, self.__dim[1]*10))
        red_total = norm_font.render("Total rum :" + str(round(self.__red_team._Team__rum,2)), False, (230,230,230))
        self.screen.blit(red_total, ((self.__dim[0])*20+50, self.__dim[1]*12))
        red_total = norm_font.render("Total gunpowder :" + str(round(self.__red_team._Team__gunpowder,2)), False, (230,230,230))
        self.screen.blit(red_total, ((self.__dim[0])*20+50, self.__dim[1]*12 + 20))

        red_total = norm_font.render("Total wood :" + str(round(self.__red_team._Team__wood,2)), False, (230,230,230))
        self.screen.blit(red_total, ((self.__dim[0])*20+50, self.__dim[1]*12 + 40))

        red_Pirates = norm_font.render("No. of Pirates: " +str(len(self.__red_pirates)), False, (230,230,230))
        self.screen.blit(red_Pirates, ((self.__dim[0])*20+50, self.__dim[1]*12 + 60))

        stat1 = head_font.render("Island 1", False, (255,130,130))
        s1 = head_font.render(str(self.status1), False, (255,130,130))
        self.screen.blit(s1, ((self.__dim[0])*20+300, self.__dim[1]*12 + 140))
        s2 = head_font.render(str(self.status2), False, (255,130,130))
        self.screen.blit(s2, ((self.__dim[0])*20+300, self.__dim[1]*12 + 160))
        s3 = head_font.render(str(self.status3), False, (255,130,130))
        self.screen.blit(s3, ((self.__dim[0])*20+300, self.__dim[1]*12 + 180))

        self.screen.blit(stat1, ((self.__dim[0])*20+50, self.__dim[1]*12 + 140))
        stat2 = head_font.render("Island 2", False, (255,130,130))
        self.screen.blit(stat2, ((self.__dim[0])*20+50, self.__dim[1]*12 + 160))
        stat3 = head_font.render("Island 3", False, (255,130,130))
        self.screen.blit(stat3, ((self.__dim[0])*20+50, self.__dim[1]*12 + 180))        
    ...
    def collect(self):        
        ...
        for key in self.__PositionToPirate.keys():
            value = self.__PositionToPirate[key]
            if self.__Pirates[key[0]][key[1]] == 1 or self.__Pirates[key[0]][key[1]] == 2:
    ...
    def winner(self, team):
        ...
        if team == "blue":
            print( "Blue Wins")
            game_over = game_over_font.render(self.bname+" Wins", True, (100,100,255), (230,230,230))
            ...
            print("Red Wins")
            game_over = game_over_font.render(self.rname+" Wins", True, (255,100,100), (230,230,230))
            self.screen.blit(game_over, ((self.__dim[0])*10,(self.__dim[0])*10))
            pygame.display.flip()
            #time.sleep(5)
            while True:
    ...
    def time_up(self):
        ...
        if nr > nb:
            ...
            if len(self.__blue_pirates) > len(self.__red_pirates):
                ...
                if 0.5*self.__red_team._Team__rum + 0.3*self.__red_team._Team__gunpowder + 0.2*self.__red_team._Team__wood > 0.5*self.__blue_team._Team__rum + 0.3*self.__blue_team._Team__gunpowder + 0.2*self.__blue_team._Team__wood:
                    self.winner("red")
                elif 0.5*self.__red_team._Team__rum + 0.3*self.__red_team._Team__gunpowder + 0.2*self.__red_team._Team__wood < 0.5*self.__blue_team._Team__rum + 0.3*self.__blue_team._Team__gunpowder + 0.2*self.__blue_team._Team__wood:
                    self.winner("blue")
                else:
                    return None
